...
class RBI2 {
    ...
    float timeperiod = 3;
     float interest() {
        float RbiInterest = (amount*RPercentageInterest*timeperiod)/100;
        return RbiInterest;
    }
}
   class SBI2 extends RBI2 {
       ...
       float timeperiod = 4;
    float interest() {
        float SbiInterest = (amount*RPercentageInterest*timeperiod)/100;
        return SbiInterest;
    }
}
    class HDFC2 extends RBI2 {
        ...
        float timeperiod = 5;
        float interest() {
            float HdfcInterest = (amount*RPercentageInterest*timeperiod)/100;
            return  HdfcInterest;
        }
    }
        class ICICI2 extends RBI2 {
            ...
            float timeperiod = 6;
            float interest() {
                float IciciInterest =(amount*RPercentageInterest*timeperiod)/100;
    ...
    public static void main(String args[]) {
        ...
        HDFC2 H = new HDFC2();
        ICICI2 I = new ICICI2();
        float RbiInterest = R.interest()/10;
        System.out.println("RBI INTEREST :"+RbiInterest);
        float SbiInterest = S.interest()/100;
        System.out.println("SBI INTEREST :"+SbiInterest);
        float HdfcInterest = H.interest()/100;
        System.out.println("HDFC INTEREST :"+HdfcInterest);
        float IciciInterest = I.interest()/1000;
