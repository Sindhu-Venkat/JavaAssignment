...
class RBI3{
    ...
    int interest(int interestrate){
        int RbiInterest = amount * RPercentage;
        return RbiInterest;
    }
}
class SBI3 extends RBI3{
    int SPercentage = 3;
    int interest(int interestrate){
        int SbiInterest = super.amount * SPercentage;
        return SbiInterest;
    }
}
class HDFC3 extends RBI3{
    int HPercentage = 4;
    int interest(int interestrate){
        int HdfcInterest = super.amount * HPercentage;
        return HdfcInterest;
    }
}
class ICICI3 extends RBI3{
    int IPercentage = 5;
    int interest( int interestrate){
        int IciciPercentage = super.amount * IPercentage;
